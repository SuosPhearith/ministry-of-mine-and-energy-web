...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      ...
      sans: ["Noto Sans Khmer", "Arial", "sans-serif"],
    },
    screens: {
      "2xsm": "375px",
      xsm: "425px",
    ...
    extend: {
      ...
      backgroundSize: {
        "50%": "50%",
        "custom-size": "150px", // Example custom size
        // Add more custom sizes if needed
      },
      backgroundImage: {
        video: "url('../images/video/video.png')",
        "kbach-1": "url('/images/mme/home/about/Kbach-1.png')",
        "kbach-2": "url('/images/mme/home/about/Kbach-2.png')",
        "about-pattern": "url('/images/mme/home/about/about.png')",
      },
      content: {
      ...
      animation: {
        "card-slide": "slide 5s ease-in-out infinite",
