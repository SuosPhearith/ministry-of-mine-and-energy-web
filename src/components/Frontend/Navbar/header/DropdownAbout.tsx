  ...
  return (
    <div className="relative z-99999">
      <div
        ...
        className={`flex cursor-pointer items-center gap-2 hover:text-warning ${pathname.startsWith("/about") ? "text-warning" : ""}`}
      >
        <span className="hidden text-right lg:block">អំពីក្រសូង</span>
